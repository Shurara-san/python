...
class Cell:
    ...
    def __str__(self):
        return "Количество клеток равно " + str(self.number)
    ...
    def __sub__(self, other):
        if self.number > other.number:
            ...
            print("Количество клеток первого объекта не превосходит"
                  "количества клеток второго объекта")
            return 0
